...
std::string Computer::generate(Board &boardObj)
{
	...
	while(1)
	{
		...
		if( (board[yStart][xStart] == 'r') || (board[yStart][xStart] == 'n') || (board[yStart][xStart] == 'b') || (board[yStart][xStart] == 'q') || (board[yStart][xStart] == 'k') || (board[yStart][xStart] == 'p')) {
			int xSt = xStart;
			int ySt = yStart;
